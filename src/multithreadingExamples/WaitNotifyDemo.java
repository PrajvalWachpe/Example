...
/*
 * when we use synchronization many threads are locked out of the object and they
 * Continuously are running to check if the object is available or not. This is called 
 * thread pooling. Such type of pooling cause unnecessary burden on the machine hence we use wait 
 * and notify method so that thread can communicate with each other and polling is avoided.\
 * 
